...
namespace ToDoList
{
    ...
    using (ToDoDataContext db = new ToDoDataContext(DBConnectionString))
    {
        if (db.DatabaseExists() == false)
        {
            ...
            db.Categories.InsertOnSubmit(new ToDoCategory { Name = "Genk" });
            db.Categories.InsertOnSubmit(new ToDoCategory { Name = "Hasselt" });
            db.Categories.InsertOnSubmit(new ToDoCategory { Name = "StTruiden" });
            db.Categories.InsertOnSubmit(new ToDoCategory { Name = "Overpelt" });
            db.Categories.InsertOnSubmit(new ToDoCategory { Name = "Tongeren" });
